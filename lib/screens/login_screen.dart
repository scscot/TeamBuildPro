...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // Navigation is handled by the AuthWrapper after successful login.
    } on FirebaseAuthException catch (e) {
      // MODIFIED: Added 'mounted' check before using the context.
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Welcome! Sign In')),
